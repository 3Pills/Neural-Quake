...
int  Con_Printf (const char *fmt, ...) __attribute__((__format__(__printf__,1,2)));
int  Con_Warning (const char *fmt, ...) __attribute__((__format__(__printf__,1,2))); //johnfitz
int  Con_DPrintf (const char *fmt, ...) __attribute__((__format__(__printf__,1,2)));
int  Con_DPrintf2 (const char *fmt, ...) __attribute__((__format__(__printf__,1,2))); //johnfitz
int  Con_SafePrintf (const char *fmt, ...) __attribute__((__format__(__printf__,1,2)));
