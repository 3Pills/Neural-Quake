...
#if 0
	key_map[SDLK_KP_0]           = K_KP_INS;
	key_map[SDLK_KP_1]           = K_KP_END;
	key_map[SDLK_KP_2]           = K_KP_DOWNARROW;
	key_map[SDLK_KP_3]           = K_KP_PGDN;
	key_map[SDLK_KP_4]           = K_KP_LEFTARROW;
	key_map[SDLK_KP_5]           = K_KP_5;
	key_map[SDLK_KP_6]           = K_KP_RIGHTARROW;
	key_map[SDLK_KP_7]           = K_KP_HOME;
	key_map[SDLK_KP_8]           = K_KP_UPARROW;
	key_map[SDLK_KP_9]           = K_KP_PGUP;
	key_map[SDLK_KP_PERIOD]     = K_KP_DEL;
	key_map[SDLK_KP_DIVIDE]     = K_KP_SLASH;
	key_map[SDLK_KP_MULTIPLY]   = K_KP_STAR;
	key_map[SDLK_KP_MINUS]      = K_KP_MINUS;
	key_map[SDLK_KP_PLUS]       = K_KP_PLUS;
	key_map[SDLK_KP_ENTER]      = K_KP_ENTER;
...
//                            break;
                ...
                case SDL_KEYUP:
					...
					Key_Event (scancode, event.key.type == SDL_KEYDOWN);
/*
