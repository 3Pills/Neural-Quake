...
// open the demo file
	...
	File_URL_Edit_Force_Extension (playdemo_name_url, ".dem", sizeof(playdemo_name_url));
	Con_Printf ("Playing demo from %s.\n", File_URL_SkipPath(playdemo_name_url));

	COM_FOpenFile (File_URL_SkipPath(playdemo_name_url), &cls.demofile);
	if (!cls.demofile)
	{
		Con_Printf ("ERROR: couldn't open %s\n", playdemo_name_url);
	...
	CL_PlayDemo_Opened (playdemo_name_url);
}
