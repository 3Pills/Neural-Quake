...
void Dedicated_Printf (const char *fmt, ...) __attribute__((__format__(__printf__,1,2))); // send text to the console
...
void System_Quit (void) __attribute__((__noreturn__));
void System_Error (const char *fmt, ...) __attribute__((__format__(__printf__,1,2), __noreturn__));
