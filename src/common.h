...
void COM_AddGameDirectory (const char *relative_dir);
...
#define FS_FullPath_From_QPath(_s,_path) _FS_FullPath_From_QPath (_s, sizeof(_s), _path);
void _FS_FullPath_From_Basedir (char s[], size_t len, const char *basedirpath);
#define FS_FullPath_From_Basedir(_s,_path) _FS_FullPath_From_Basedir (_s, sizeof(_s), _path);
